...
*/
  ...
  static List<charts.Series<OrdinalSales, String>> _createSampleData() {
    final data = [
      new OrdinalSales('20/10/20', 5),
      new OrdinalSales('20/11/20', 30),
      new OrdinalSales('20/12/20', 100),
      new OrdinalSales('20/01/21', 85),
      /*  
      new OrdinalSales('20/04/21', 85),    
      new OrdinalSales('2015', 125),
      new OrdinalSales('2016', 100),
      new OrdinalSales('2017', 175),
      new OrdinalSales('2018', 95),
      new OrdinalSales('2019', 125),
      new OrdinalSales('2020', 100),
      new OrdinalSales('2021', 175),
      */
    ];
