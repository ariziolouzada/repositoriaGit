import 'package:app_vix_capital/graficos/rendimentoGrafico.dart';
import 'package:flutter/material.dart';

class RendimentoTab extends StatelessWidget {
  final _scaffoldkey = GlobalKey<ScaffoldState>();

  final int idInvestimento;

  RendimentoTab({this.idInvestimento});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldkey,
      appBar: AppBar(
        title: Text("Gráfico Rendimentos"),
        centerTitle: true,
        backgroundColor: Theme.of(context).primaryColor,
      ),
      body: RendimentoGraficos(
...
*/
          ...
          return ListTile(
            ...
            subtitle: Text((values[index].DataStr).toString()),
          );
        },
